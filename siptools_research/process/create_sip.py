...
/etc/cron.d/create-sip::
    ...
    # | | | | |
    */10 * * * * * <username>  /usr/bin/create_sip.py ProcessSIP
...
from siptools_research.create_sip.send_sip import SendSIPToDP


class ProcessSIP(luigi.WrapperTask):
        ...
        for workspace_path in cache_items(
            ...
            yield SendSIPToDP(
                ...
                sip_creation_path=os.path.join(workspace_path,
                                               'sip-in-progress'),
                sip_output_path=os.path.join(workspace_path, 'created-sip'),
