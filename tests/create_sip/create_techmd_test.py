...
def test_create_techmd_ok(testpath, tarfile):
    ...
    assert os.path.isfile(os.path.join(sip_creation_path, 'sahke2.xml-techmd.xml'))
    assert os.path.isfile(os.path.join(sip_creation_path, 'test.xml-techmd.xml'))
