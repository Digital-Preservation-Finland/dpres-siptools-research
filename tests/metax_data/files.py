...
from metax_access.template_data import FILE
...
SEG_Y_FILE = deepcopy(FILE)
SEG_Y_FILE.update(SEG_Y_FILE_METADATA)
SEG_Y_CHARACTERISTICS = deepcopy(FILE['characteristics'])
