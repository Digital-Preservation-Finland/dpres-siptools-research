...
def test_download_file(testpath):
    ...
    ida.download_file('file_path','pid:urn:1', new_file_path,
...
def test_download_big_file_header(testpath):
    ...
    """
    new_file_path = os.path.join(testpath, 'new_file')
    ida.download_file_header('file_path', 'pid:urn:1024kB_file', new_file_path,
                             tests.conftest.UNIT_TEST_CONFIG_FILE)
...
def test_download_short_file_header(testpath):
    ...
    """
    new_file_path = os.path.join(testpath, 'new_file')
    ida.download_file_header('file_path', 'pid:urn:1', new_file_path,
                             tests.conftest.UNIT_TEST_CONFIG_FILE)
