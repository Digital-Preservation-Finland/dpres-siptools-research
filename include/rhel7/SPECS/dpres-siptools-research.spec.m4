...
BuildArch:      noarch
Requires:       python python-luigi python-pymongo dpres-siptools addml mets python-lxml python-paramiko python2-jsonschema python-requests python-scandir mongodb-org-server
